...
(function ($) {
    ...
    var PicTip = function (el) {
        ...
        this.init = function (options) {
            ...
            for (i = 0; i < opts.spots.length; i++) {
				spotTemplate = $(opts.spotTemplate[i]).addClass(opts.spotClass.replace('.', ''));
    ...
    $.fn.pictip.options = {
        ...
        spotTemplate: [], // HTML markup to create the spots
        eventType: 'mouseover', // type of event that trigger the tooltip/caption display action (click, hover)
