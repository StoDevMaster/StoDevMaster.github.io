...
function ud_anal_login(userid) {
    try {
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                callAjaxReq(anal_src + "/Anal/Login", ("skey=" + site_log_key + "&ckey=" + site_conn_key + "&userid=" + userid), function (res_data) {
        ...
        for (var icnt = 0; icnt < data.length; icnt++) {
          ...
          $.ajax({
            ...
            data:  {
                ...
                realprc: realprc,
                cnt: cnt,
                stco_userid : stco_userid
            },
            success: function (data, textStatus) {
                console.log(data);
            },
            error: function (xhr, status, error) {
                callAjaxReq(anal_src + "/Anal/Order", ("skey=" + site_log_key + "&ckey=" + site_conn_key + "&ordno=" + ordno + "&prdcd=" + prdcd + "&prdnm=" + prdnm + "&saleprc=" + saleprc + "&realprc=" + realprc + "&cnt=" + cnt + "&stco_userid=" + stco_userid), function (res_data) {
